...
public class ImageController {
    ...
    public ResponseEntity<Object> uploadFile(@RequestParam("file") MultipartFile file) {
        ...
        if (originalFilename.length() > 0) {
            ...
            if (!extension.equals("png") && !extension.equals("jpg") && !extension.equals("gif") && !extension.equals("svg") && !extension.equals("jpeg")) {
                throw new BadRequestExp("Không hỗ trợ định dạng file này!");
            }
            try {
                ...
                throw new InternalServerExp("Có lỗi trong quá trình upload file!");
            }
        }
        throw new BadRequestExp("File không hợp lệ!");
    }
    ...
    public ResponseEntity<Object> downloadFile(@PathVariable String filename) {
        ...
        if (!file.exists()) {
            throw new NotFoundExp("File không tồn tại!");
        }
